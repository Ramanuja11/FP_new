`timescale 1ns / 1ps
module FP_div_TB #(parameter XLEN = 32);
reg [XLEN-1:0] A,B;
reg clk;
...
wire zero_division;
real  value;
FloatingDivision F_Div (.A(A),.B(B),.result(result),.zero_division(zero_divisions));
...
B = 32'b1_01111110_00000000000000000000001;  // -0.5
#20
